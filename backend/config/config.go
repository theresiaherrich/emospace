...
func InitDB() error {
	...
	err = db.AutoMigrate(&models.User{}, &models.Mood{}, &models.ChatLog{}, &models.ChatStage{}, &models.PremiumPlan{}, &models.Transaction{}, &models.Journal{}, &models.Consultan{}, &models.ConsultanAccess{})
	if err != nil {
